...
const DEFAULT_SCORING_RULES = [
  { id: "win_challenge", label: "Win Challenge", points: 10, category: "competition" },
  { id: "win_immunity", label: "Win Immunity", points: 15, category: "competition" },
  { id: "win_reward", label: "Win Reward", points: 5, category: "competition" },
  { id: "found_advantage", label: "Found Advantage/Power", points: 8, category: "strategy" },
  { id: "played_idol", label: "Played Idol Correctly", points: 12, category: "strategy" },
  { id: "blindside", label: "Orchestrated Blindside", points: 10, category: "strategy" },
  { id: "survived_tribal", label: "Survived Elimination", points: 3, category: "survival" },
  { id: "eliminated", label: "Eliminated", points: -5, category: "survival" },
  { id: "top_dish", label: "Top Dish / Best Performance", points: 8, category: "competition" },
  { id: "fan_favorite", label: "Fan Favorite Moment", points: 5, category: "bonus" },
  { id: "drama_villain", label: "Villain Edit / Drama", points: 2, category: "bonus" },
  { id: "quote_of_week", label: "Iconic Quote", points: 3, category: "bonus" },
  { id: "crying", label: "Cried on Camera", points: 1, category: "bonus" },
];
