                  ...
                  {allRoster.map(({ c, mult, role }) => {
                    ...
                    return (
                      <div key={c.id} style={{ display:"flex",alignItems:"center",gap:8,padding:"4px 0" }}>
                        ...
                        {c.photoUrl && <div style={{ width:20,height:20,borderRadius:5,overflow:"hidden",flexShrink:0 }}>
                          <img src={c.photoUrl} alt="" style={{ width:"100%",height:"100%",objectFit:"cover",objectPosition:`center ${c.photoCropY||20}%`,transform:`scale(${c.photoCropZoom||1})`,transformOrigin:`center ${c.photoCropY||20}%` }} onError={e=>{e.target.style.display="none"}} />
                        </div>}
                ...
                <button key={c.id} onClick={()=>{ setEditorTarget(c); setEditorOpen(true); }} style={{
                  ...
                  {c.photoUrl ? (
                    <div style={{ width:36,height:36,borderRadius:8,overflow:"hidden",flexShrink:0 }}>
                      <img src={c.photoUrl} alt="" style={{ width:"100%",height:"100%",objectFit:"cover",objectPosition:`center ${c.photoCropY||20}%`,transform:`scale(${c.photoCropZoom||1})`,transformOrigin:`center ${c.photoCropY||20}%` }} />
                    </div>
                  ) : (
